            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            if (isset($_POST['btn']))
                            {
                                ...
                                if ($first_name == ''){
                                    ...
                                    if ($count > 0) {
                                        ...
                                        $sql = $connect->query("INSERT INTO users (first_name, last_name, email, phone, date_of_birth, gender, address, nid, education_certificate, institute, join_date, status, role, image, password) VALUES ('$first_name', '$last_name', '$email', '$phone', '$birth', '$gender', '$address', '$nid', '$certificate', '$institute', '$join_date', '1', 'tutor', '$image', '$has')");
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 float-left">
                            <label>Last Education Certificate<sup class="text-danger font-weight-bold">*</sup></label>
                ...
                <div class="card-footer">
                    <span>All Ready Registered? <a href="index.php">Login Now</a> <a href="registration.php" class="float-right">Student Registration</a></span>
                </div>
            </div>
